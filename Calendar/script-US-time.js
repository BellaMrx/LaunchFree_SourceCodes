function EventCalendarApp(date) {
  ...
  this.apts = [
    {
     ...
     {
      name: 'Easter monday',
      endTime: new Date(2023, 3, 11, 23, 59),
      startTime: new Date(2023, 3, 11, 0),
      day: new Date(2023, 3, 11).toString()
    },
    
  ];
  
  this.aptDates = [new Date(2023, 3, 9).toString(),new Date(2023, 3, 11).toString()];
  this.elements = {
  };
  ...
  this.addEventForm = {
    ...
    startAMPM:  document.getElementById("input_Event_Start_am-pm"),
    endAMPM:  document.getElementById("input_Event_End_am-pm")
  };
...
EventCalendarApp.prototype.addEventListeners = function() {
  ...
  this.addEventForm.startAMPM.addEventListener("keyup",this.inputChangeLimiter.bind(this));
  this.addEventForm.endTime.addEventListener("keyup",this.inputChangeLimiter.bind(this));
  this.addEventForm.endAMPM.addEventListener("keyup",this.inputChangeLimiter.bind(this));
...
EventCalendarApp.prototype.cleanEventTimeStampDates = function() {
  ...
  var startAMPM = this.addEventForm.startAMPM.value.trim() || this.addEventForm.startAMPM.getAttribute("placeholder") || 'am';
  ...
  var endAMPM = this.addEventForm.endAMPM.value.trim() || this.addEventForm.endAMPM.getAttribute("placeholder") || 'pm';
...
EventCalendarApp.prototype.validateAddEventInput = function() {
  ...
  var startAMPM = this.addEventForm.startAMPM.value.trim();
  var endTime = this.addEventForm.endTime.value.trim();
  var endAMPM = this.addEventForm.endAMPM.value.trim();
...
EventCalendarApp.prototype.inputChangeLimiter = function(el) {
  ...
  // option for time format 1-12, am pm 
...
EventCalendarApp.prototype.resetAddEventBox = function(){
  ...
  this.addEventForm.endAMPM.value = '';
  this.addEventForm.startAMPM.value = '';
};
